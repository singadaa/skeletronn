...
define config.name = _("Помощник Кыш-Бабая")
...
define gui.about = _p("""
"Помощник Кыш-Бабая" - небольшое приключение о спасении Нового года.\n
Перед юным Артуром то и дело встает выбор. \n
Но сумеет ли он заручиться поддержкой героев из татарских легенд и спасти наступающий праздник?\n

Игра подготовлена командой по спасению Нового года\n
(Бахмат М., Дмитриев А., Закирова З., Казакова Э., Мельник Р.)
\n
\n
\nFR
""")
...
define config.save_directory = "skelet-1671304945"
